...
22. In the "Question 8" section of your document, add a code chunk. In this chunk, write the syntax included in Question 2 from Assignment 1 to compute the summary statistics.
