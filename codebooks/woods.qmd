...
The data in [woods.csv](https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/woods.csv) were collected from several sources to assesses the effect of political corruption on state environmental policy [@woods:2008].
...
```{r}
# Import data
woods = readr::read_csv(file = "https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/woods.csv")
