...
The data in [usnwr-2024.csv](https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/usnwr-2024.csv) includes 13 attributes collected from the n=111 graduate schools of education ranked in the U.S. News and World Report’s 2023--2024 Best Education Graduate Schools.
...
```{r}
# Import data
usnwr = readr::read_csv(file = "https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/usnwr-2024.csv")
