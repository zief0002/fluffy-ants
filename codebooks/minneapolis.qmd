...
The data in [minneapolis.csv](https://raw.githubusercontent.com/zief0002/benevolent-anteater/main/data/minneapolis.csv) were provided in @Long:2012. They constitute a sample of $n=22$ students taken from a much larger dataset collected by the Minneapolis Public School District. The data were collected to comply with the No Child Left Behind Act of 2001 and began during the 2004-05 school year. The variables included in the data are:
