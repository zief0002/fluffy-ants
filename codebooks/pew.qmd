...
The data in [pew.csv](https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/pew.csv) come from a telephone survey conducted by [The Pew Research Center for The People &amp; The Press](https://www.pewresearch.org/politics/2007/04/15/public-knowledge-of-current-affairs-little-changed-by-news-and-information-revolutions/) in February 2007. The data represent a probability sample of 100 adults in the U.S. The attributes in the dataset include:
...
- `education`: Respondent's education level; indicates highest grade completed from 8 to 18 (a post masters degree)
...
```{r}
# Import data
pew = readr::read_csv(file = "https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/pew.csv")
