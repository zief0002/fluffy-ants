...
The data in [same-sex-marriage.csv](https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/same-sex-marriage.csv) were collected from a poll taken by Pew Research Center in 2015. These particular data consist of 500 American's responses. The attributes are:
...
```{r}
# Import data
same_sex = readr::read_csv(file = "https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/same-sex-marriage.csv")
