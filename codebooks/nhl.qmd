...
The data in [nhl.csv](https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/nhl.csv) includes data on the cost of attending an NHL game over nine seasons for the current 31 NHL teams. The attributes include:
...
```{r}
# Import data
nhl = readr::read_csv(file = "https://raw.githubusercontent.com/zief0002/fluffy-ants/main/data/nhl.csv")
